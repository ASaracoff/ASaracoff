...
let {first,second,...other} = locations
...
// remaining -> from task 2?

let {upper,middle = other.third, lower} = doorCode
...
function revealPath({direction,distance}) {
    console.log(`Path: Move ${distance} feet to the ${direction}` )
}

revealPath({direction:'West',distance:'20'})
...
//     console.log(`spell:` + ingredient1 + 'and' + ingredient2)
// }
// console.log('castSpell',castSpell(one,two))
