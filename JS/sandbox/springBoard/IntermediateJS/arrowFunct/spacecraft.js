...
const currentCoordinates = () => ({ x: 21, y:67, z:643 })
...
const spacecraft = {
        ...
        receiveMessage: function(mess) {
            ...
            console.log(`Message Arived to: "${this.name}"`);
        }
    }
...
console.log(spacecraft.receiveMessage('Hello, I miss you T.T'))

/*
 * Observations: The message does get implimented, but 'this' does not - it is undefined.
 

* TODO: Explain here.
        this in the arrow funct shortcut refers to the window scope NOT the object
 */
